...
echo '  REM  echo PWSH Version 7; current powershell      ' >> DiscusWSL/discus_suite_ps1.bat
...
echo '  REM  echo PWSH Version 6; may exist on older     ?' >> DiscusWSL/discus_suite_ps1.bat

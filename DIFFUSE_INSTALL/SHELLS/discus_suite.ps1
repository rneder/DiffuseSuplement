#REM DISCUS_SUITE VIA UBUNTU; Powershell version for Windows 10/11
#
#
cd "$HOME"
...
cd "$HOME"
#
Start-Process "$UBUNTU_EXE" -WindowStyle Hidden -ArgumentList "-c `"cd ; source .profile.local; discus_suite_ubuntu.sh $wsl_use $win_ver`""

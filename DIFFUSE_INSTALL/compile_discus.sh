...
export FC=$DISCUS_GFORTRAN
export CC=$DISCUS_GCC
export CXX=$DISCUS_GXX
#
if [[ "$OPERATING" == "DISCUS_LINUX" || "$OPERATING" == "DISCUS_WSL_LINUX" ]]; then
#
  cmake -DDIFFEV_MPI=$DIFFEV_MPI_FLAG  -DDEBUG=OFF -DDIFFUSE_PYTHON=OFF -DDISCUS_CUDA=OFF -DDISCUS_OMP=ON -DDIFFUSE_SHARED_LIB=ON -DPGPLOT_DIR=$PGPLOT_ROOT_DIR/pgplot -DPGPLOT_INCLUDE_DIR=$PGPLOT_ROOT_DIR/pgplot -DPGPLOT_PGPLOT_LIBRARY=$PGPLOT_ROOT_DIR/pgplot/libpgplot.so -DPGPLOT_CPGPLOT_LIBRARY=$PGPLOT_ROOT_DIR/pgplot/libcpgplot.so -DCMAKE_INSTALL_PREFIX=$DISCUS_BIN_PREFIX ../DiffuseCode
#  cmake -DDIFFEV_MPI=$DIFFEV_MPI_FLAG  -DDEBUG=OFF -DDIFFUSE_PYTHON=OFF -DDISCUS_CUDA=OFF -DDISCUS_OMP=OFF -DDIFFUSE_SHARED_LIB=ON -DHDF5_DIR=$HDF5_DIR -DPGPLOT_DIR=$PGPLOT_ROOT_DIR/pgplot -DPGPLOT_INCLUDE_DIR=$PGPLOT_ROOT_DIR/pgplot -DPGPLOT_PGPLOT_LIBRARY=$PGPLOT_ROOT_DIR/pgplot/libpgplot.so -DPGPLOT_CPGPLOT_LIBRARY=$PGPLOT_ROOT_DIR/pgplot/libcpgplot.so -DCMAKE_INSTALL_PREFIX=$DISCUS_BIN_PREFIX ../DiffuseCode
#
...
# Temporarily while phasing out the standalone programs DISCUS, DIFFEV, KUPLOT, REFINE, MIXSCAT
  ...
  cmake -DDIFFEV_MPI=$DIFFEV_MPI_FLAG  -DDEBUG=OFF -DDIFFUSE_PYTHON=OFF -DDISCUS_CUDA=OFF -DDISCUS_OMP=ON -DDIFFUSE_SHARED_LIB=ON -DHDF5_DIR=$HDF5_DIR -DPGPLOT_DIR=$PGPLOT_ROOT_DIR/pgplot -DPGPLOT_INCLUDE_DIR=$PGPLOT_ROOT_DIR/pgplot -DPGPLOT_PGPLOT_LIBRARY=$PGPLOT_ROOT_DIR/pgplot/libpgplot.so -DPGPLOT_CPGPLOT_LIBRARY=$PGPLOT_ROOT_DIR/pgplot/libcpgplot.so -DCMAKE_INSTALL_PREFIX=$DISCUS_BIN_PREFIX ../DiffuseCode
#
elif  [[ "$OPERATING" == "DISCUS_MACOS" ]]; then
#
  cmake -DDIFFEV_MPI=$DIFFEV_MPI_FLAG  -DDEBUG=OFF -DDIFFUSE_PYTHON=OFF -DDISCUS_CUDA=OFF -DDISCUS_OMP=ON -DDIFFUSE_SHARED_LIB=OFF -DHDF5_DIR=$HDF5_DIR -DPGPLOT_DIR=$PGPLOT_ROOT_DIR/pgplot -DPGPLOT_INCLUDE_DIR=$PGPLOT_ROOT_DIR/pgplot -DPGPLOT_PGPLOT_LIBRARY=$PGPLOT_ROOT_DIR/pgplot/libpgplot.so -DPGPLOT_CPGPLOT_LIBRARY=$PGPLOT_ROOT_DIR/pgplot/libcpgplot.so -DCMAKE_INSTALL_PREFIX=$DISCUS_BIN_PREFIX ../DiffuseCode
#
fi
#
if [[ "$1" == "clean" ]]; then

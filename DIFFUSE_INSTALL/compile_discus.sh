...
#
echo "IN compile discus"
echo "HDF5_DIR is : $HDF5_DIR"
#
  cmake -DDIFFEV_MPI=$DIFFEV_MPI_FLAG  -DDEBUG=OFF -DDIFFUSE_PYTHON=OFF -DDISCUS_CUDA=OFF -DDISCUS_CUDA=OFF -DPGPLOT_DIR=$PGPLOT_ROOT_DIR/pgplot -DPGPLOT_INCLUDE_DIR=$PGPLOT_ROOT_DIR/pgplot -DPGPLOT_PGPLOT_LIBRARY=$PGPLOT_ROOT_DIR/pgplot/libpgplot.a -DPGPLOT_CPGPLOT_LIBRARY=$PGPLOT_ROOT_DIR/pgplot/libcpgplot.a -DCMAKE_INSTALL_PREFIX=$DISCUS_BIN_PREFIX ../DiffuseCode
#  cmake -DDIFFEV_MPI=$DIFFEV_MPI_FLAG  -DDEBUG=OFF -DDIFFUSE_PYTHON=OFF -DDISCUS_CUDA=OFF -DDISCUS_CUDA=OFF -DHDF5_DIR=$HDF5_DIR -DPGPLOT_DIR=$PGPLOT_ROOT_DIR/pgplot -DPGPLOT_INCLUDE_DIR=$PGPLOT_ROOT_DIR/pgplot -DPGPLOT_PGPLOT_LIBRARY=$PGPLOT_ROOT_DIR/pgplot/libpgplot.a -DPGPLOT_CPGPLOT_LIBRARY=$PGPLOT_ROOT_DIR/pgplot/libcpgplot.a -DCMAKE_INSTALL_PREFIX=$DISCUS_BIN_PREFIX ../DiffuseCode
#
...
# Temporarily while phasing out the standalone programs DISCUS, DIFFEV, KUPLOT, REFINE, MIXSCAT
  ...
  cmake -DDIFFEV_MPI=$DIFFEV_MPI_FLAG  -DDEBUG=OFF -DDIFFUSE_PYTHON=OFF -DDISCUS_CUDA=OFF -DDISCUS_CUDA=OFF =$HDF5_DIR -DPGPLOT_DIR=$PGPLOT_ROOT_DIR/pgplot -DPGPLOT_INCLUDE_DIR=$PGPLOT_ROOT_DIR/pgplot -DPGPLOT_PGPLOT_LIBRARY=$PGPLOT_ROOT_DIR/pgplot/libpgplot.a -DPGPLOT_CPGPLOT_LIBRARY=$PGPLOT_ROOT_DIR/pgplot/libcpgplot.a -DCMAKE_INSTALL_PREFIX=$DISCUS_BIN_PREFIX ../DiffuseCode
#
